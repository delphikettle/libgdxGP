...
public class TutorialListActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        final List<String> tutorialsNames = GameLevels.getTutorialsNames(false);
        adapter = new ArrayAdapter<String>(this, R.layout.level_list_item, tutorialsNames);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View itemClicked, int position,
                ...
                Intent intent = new Intent(TutorialListActivity.this, AndroidLauncher.class);
